...
const pageTitle = ref('Normandie'); // Browser tab title
...
Dans le cadre de l’élaboration<br< de son schéma directeur cyclable,<br><br> la communauté d’agglomération de Seine Normandie agglomeration <br>réalise un sondage sur la perception et la pratique du vélo auprès de la population locale afin d’évaluer plus précisément les profils d’usagers,<br><br> les types de pratiques et les difficultés rencontrées en la matière.<br><br> Merci d'avance pour votre contribution !
